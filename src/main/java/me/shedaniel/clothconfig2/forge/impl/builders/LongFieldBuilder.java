...
public class LongFieldBuilder extends FieldBuilder<Long, LongListEntry> {
    ...
    public LongFieldBuilder setErrorSupplier(Function<Long, Optional<ITextComponent>> errorSupplier) {
    ...
    public LongFieldBuilder setTooltipSupplier(Supplier<Optional<ITextComponent[]>> tooltipSupplier) {
        this.tooltipSupplier = l -> tooltipSupplier.get();
        return this;
    }
    
    public LongFieldBuilder setTooltipSupplier(Function<Long, Optional<ITextComponent[]>> tooltipSupplier) {
